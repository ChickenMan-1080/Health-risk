...
## วิธีการทำงาน
 ...
 4. **ขั้นตอนการเลือกข้อมูล :** เลือกข้อมูลที่จะเข้ามา Train Model โดยการ Plot กราฟ โดยที่ผมเลือกที่จะทำแค่ **Bivariate analysis** เพื่อดูความต่างของตัวแปร y ที่เทียบกับ x ว่ามีการเปลี่ยนแปลงของ กราฟมากแค่ไหน หากตัวแปร y มีการเปลี่ยนแปลงที่ชัดเจนแปลว่า ตัวแปร x ตัวนั้นมีผลต่อการเปลี่ยนแปลงของ **Target** อย่างมีนัยสำคัญ ดังนั้นจะพิจารณาไม่ตัดตัวแปรนั้นออกตอนลดค่า **Multicollinearity**
**(ตอนทำ VIF)** 
